    ...
    public class EmbedBuilderFactory : IEmbedBuilderFactory
    {
        ...
        public List<List<Embed>> BuildSoulbreakEmbeds(string tier, string charName, int? index)
        {
            ...
            foreach (var soulbreak in soulbreaks)
            {
                ...
                if (soulbreak.ZenithAbilities.Count() != 0) {
        ...
        public IList<Embed> BuildZenithAbilityEmbeds(IList<ZenithAbility> zenithAbilities)
        {
            var embeds = new List<Embed>();

            if (zenithAbilities == null)
            {
                var embed = new EmbedBuilder();
                embed.Title = "No Zenith Abilities Found";
                embeds.Add(embed.Build());
                return embeds;
            }
